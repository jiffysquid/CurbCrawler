...
- November 23, 2025: UI POLISH - Hidden GPS debug panel from production view, reduced info panel z-index from z-[1000] to z-[100] to ensure alerts/toasts appear above map overlays
- November 23, 2025: IMPLEMENTED FADE WITH AGE FEATURE - Added pathColorScheme prop to MapboxMap component with support for 'bright' (8-color cycle) and 'fade' (newer paths brighter/thicker) schemes using getPathColor utility function, integrated with localStorage sync from PathManagement settings